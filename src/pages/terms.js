        ...
        <Layout>
            ...
            <div className="py-5">
                <div className="container py-5">
                    <h2>Welcome to NordenSoft Design &amp; Software Development Labs ApS</h2>
                    <p>These terms and conditions outline the rules and regulations for the use of NordenSoft Design &amp; Software Development Labs ApS’s Website.</p>
                    <p><span className="text-uppercase"> NordenSoft Design &amp; Software Development Labs ApS</span> is located at:</p>
                    <address>Telemarksgade 11 3 t.v. , København<br />
                        København S – 2300, Danmark</address>
                    <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use NordenSoft Design &amp; Software Development Labs ApS’s website<br />
                    ...
                    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice<br />
                        ...
                        of Danmark. Any use of the above terminology or other words in the singular, plural,<br />
                        capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
                    <h2>Cookies</h2>
                    <p>We employ the use of cookies. By using NordenSoft Design &amp; Software Development Labs ApS’s website you consent to the use of cookies<br />
                        in accordance with NordenSoft Design &amp; Software Development Labs ApS’s privacy policy.</p>
                    ...
                    <h2>License</h2>
                    <p>Unless otherwise stated, NordenSoft Design &amp; Software Development Labs ApS and/or it’s licensors own the intellectual property rights for<br />
                        all material on NordenSoft Design &amp; Software Development Labs ApS. All intellectual property rights are reserved. You may view and/or print<br />
                        pages from https://www.nordensoft.dk for your own personal use subject to restrictions set in these terms and conditions.</p>
                    <p>You must not:</p>
                    <ol>
                        <li>Republish material from https://www.nordensoft.dk</li>
                        <li>Sell, rent or sub-license material from https://www.nordensoft.dk</li>
                        <li>Reproduce, duplicate or copy material from https://www.nordensoft.dk</li>
                    </ol>
                    <p>Redistribute content from NordenSoft Design &amp; Software Development Labs ApS (unless content is specifically made for redistribution).</p>
                    <h2>User Comments</h2>
                    <ol>
                        <li>This Agreement shall begin on the date hereof.</li>
                        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,<br />
                            material and data (‘Comments’) in areas of the website. NordenSoft Design &amp; Software Development Labs ApS does not screen, edit, publish<br />
                            or review Comments prior to their appearance on the website and Comments do not reflect the views or<br />
                            opinions ofNordenSoft Design &amp; Software Development Labs ApS, its agents or affiliates. Comments reflect the view and opinion of the<br />
                            person who posts such view or opinion. To the extent permitted by applicable laws NordenSoft Design &amp; Software Development Labs ApSshall<br />
                            ...
                            website.</li>
                        <li>NordenSoft Design &amp; Software Development Labs ApSreserves the right to monitor all Comments and to remove any Comments which it considers<br />
                        ...
                        <li>You hereby grant to <strong>NordenSoft Design &amp; Software Development Labs ApS</strong> a non-exclusive royalty-free license to use, reproduce,<br />
                    ...
                    <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect<br />
                        ...
                        the visibility associated with the hyperlink outweighs the absence of link is in the context of general resource information or is otherwise consistent with editorial content<br />
                    ...
                    <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,<br />
                        you must notify us by sending an e-mail to <a title="send an email to info@nordensoft.dk" href="mailto:info@nordensoft.dk" data-slimstat="5">info@nordensoft.dk</a>.<br />
                    ...
                    <p>No use of NordenSoft Design &amp; Software Development Labs ApS’s logo or other artwork will be allowed for linking absent a trademark license<br />
                        agreement.</p>
                    <h2>Iframes</h2>
                    ...
                    <p>This Terms and conditions page was created at <a href="https://termsandconditionstemplate.com" data-slimstat="5">termsandconditionstemplate.com</a> generator. If you have<br />
                        any queries regarding any of our terms, please <a href="mailto.info@nordensoft.dk" data-slimstat="5">contact</a> us.</p>
