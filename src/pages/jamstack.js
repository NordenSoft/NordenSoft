            ...
            <div className="py-5">
                <div className="container py-5">
                    <div className="jamstack">
                        ...
                        <div class="contained intro my-5 pb-5">
                        ...
                        <section class="jam-disqualifications my-5 pt-5">
                            ...
                            <div class="disqualifications">
                                ...
                                <div class="disqualification">A site built with a server-side CMS like WordPress, Drupal, Joomla, or Squarespace.</div>

                                <div class="disqualification">A monolithic server-run web app that relies on Ruby, Node, or another backend language.</div>

                                <div class="disqualification">A single page app that uses isomorphic rendering to build views on the server at runtime.</div>
